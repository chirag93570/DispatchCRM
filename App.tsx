...
import { LayoutDashboard, Phone, Settings as SettingsIcon, Headphones, Plus, Upload, DollarSign, Mail, PhoneCall, FileText, BarChart, LogOut } from 'lucide-react';
             ...
             <aside className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col hidden md:flex shrink-0">
                <div className="p-6 border-b border-gray-800">
                    <div className="flex items-center gap-3 text-primary-500">
                        ...
                        <span className="text-xs text-gray-500 font-medium">Production v1.0</span>
                        </div>
                    </div>
                </div>
...
const App: React.FC = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/*" element={session ? <ProtectedLayout>x</ProtectedLayout> : <Navigate to="/login" replace />} />
    </Routes>
  );
};
