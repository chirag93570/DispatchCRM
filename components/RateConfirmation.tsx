        ...
        <div className="h-full p-6 overflow-y-auto max-w-5xl mx-auto">
            <div className="flex justify-between items-center mb-8">
                ...
                <div className="flex gap-2">
                    <button className="px-4 py-2 bg-gray-800 text-gray-300 rounded hover:bg-gray-700 flex items-center gap-2 text-sm">
            ...
            <div className="bg-white text-black p-8 rounded-lg shadow-xl min-h-[800px]">
                {/* Header */}
                <div className="flex justify-between border-b-2 border-black pb-6 mb-6">
                    ...
                    <div className="text-right">
                        ...
                        <div className="text-sm mt-1">Order #: <span className="font-mono">RK-2024-9981</span></div>
                ...
                <div className="grid grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="border border-gray-300 p-4 bg-gray-50">
                        ...
                        <div className="text-xs text-gray-500 mt-4">
                            * Rate includes all fuel surcharges and accessorials unless otherwise noted.
                        </div>
                    </div>
                </div>
                ...
                <div className="border border-gray-300 p-4 mb-8 min-h-[100px]">
                     ...
                     <textarea className="w-full h-full resize-none outline-none text-sm" placeholder="Enter commodity details, weight, special instructions..."></textarea>
                </div>
